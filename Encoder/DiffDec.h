...
void diff_dec(MDIFF** MDIFF_VECTOR, MDIFF** MDIFF_VECTOR_DIFF, int FrameType, int row, int col) {
	...
	if (col == 0) {
		if (MDIFF_VECTOR_DIFF[row][col].split == 0)
			split_ref = false;
		else
			split_ref = true;
	}
		...
		if (MDIFF_VECTOR_DIFF[row][col].split != 0)
			split_ref = !split_ref; //flip the switch
	}

	if (FrameType == IFRAME) {
		if (!split_ref) {
			if (col == 0) {
				MDIFF_VECTOR[row][col].split = MDIFF_VECTOR_DIFF[row][col].split;
				MDIFF_VECTOR[row][col].MODE = MDIFF_VECTOR_DIFF[row][col].MODE;
				MDIFF_VECTOR[row][col].MODE2 = 0;
				MDIFF_VECTOR[row][col].MODE3 = 0;
				MDIFF_VECTOR[row][col].MODE4 = 0;
			}
			else {
				MDIFF_VECTOR[row][col].split = MDIFF_VECTOR_DIFF[row][col].split + MDIFF_VECTOR[row][col - 1].split;
			...
			if (col == 0) {
				MDIFF_VECTOR[row][col].split = MDIFF_VECTOR_DIFF[row][col].split;
				MDIFF_VECTOR[row][col].MODE = MDIFF_VECTOR_DIFF[row][col].MODE;
				MDIFF_VECTOR[row][col].MODE2 = MDIFF_VECTOR_DIFF[row][col].MODE2;
				MDIFF_VECTOR[row][col].MODE3 = MDIFF_VECTOR_DIFF[row][col].MODE3;
				MDIFF_VECTOR[row][col].MODE4 = MDIFF_VECTOR_DIFF[row][col].MODE4;
			}
			else {
				MDIFF_VECTOR[row][col].split = MDIFF_VECTOR_DIFF[row][col].split + MDIFF_VECTOR[row][col - 1].split;
				MDIFF_VECTOR[row][col].MODE = MDIFF_VECTOR_DIFF[row][col].MODE + MDIFF_VECTOR[row][col - 1].MODE;
				MDIFF_VECTOR[row][col].MODE2 = MDIFF_VECTOR_DIFF[row][col].MODE2 + MDIFF_VECTOR[row][col - 1].MODE2;
				MDIFF_VECTOR[row][col].MODE3 = MDIFF_VECTOR_DIFF[row][col].MODE3 + MDIFF_VECTOR[row][col - 1].MODE3;
				MDIFF_VECTOR[row][col].MODE4 = MDIFF_VECTOR_DIFF[row][col].MODE4 + MDIFF_VECTOR[row][col - 1].MODE4;
			}
		}
	}
	else {//P frame
		if (!split_ref) {
			if (col == 0) {
				...
				MDIFF_VECTOR[row][col].X2 = 0;
				MDIFF_VECTOR[row][col].X3 = 0;
				MDIFF_VECTOR[row][col].X4 = 0;
				MDIFF_VECTOR[row][col].Y = MDIFF_VECTOR_DIFF[row][col].Y;
				MDIFF_VECTOR[row][col].Y2 = 0;
				MDIFF_VECTOR[row][col].Y3 = 0;
				MDIFF_VECTOR[row][col].Y4 = 0;
				MDIFF_VECTOR[row][col].ref = MDIFF_VECTOR_DIFF[row][col].ref;
				MDIFF_VECTOR[row][col].ref2 = 0;
				MDIFF_VECTOR[row][col].ref3 = 0;
				MDIFF_VECTOR[row][col].ref4 = 0;
			}
			else {
				MDIFF_VECTOR[row][col].split = MDIFF_VECTOR_DIFF[row][col].split + MDIFF_VECTOR[row][col - 1].split;
			...
			if (col == 0) {
				MDIFF_VECTOR[row][col].split = MDIFF_VECTOR_DIFF[row][col].split;
				MDIFF_VECTOR[row][col].X = MDIFF_VECTOR_DIFF[row][col].X;
				MDIFF_VECTOR[row][col].X2 = MDIFF_VECTOR_DIFF[row][col].X2;
				MDIFF_VECTOR[row][col].X3 = MDIFF_VECTOR_DIFF[row][col].X3;
				MDIFF_VECTOR[row][col].X4 = MDIFF_VECTOR_DIFF[row][col].X4;
				MDIFF_VECTOR[row][col].Y = MDIFF_VECTOR_DIFF[row][col].Y;
				MDIFF_VECTOR[row][col].Y2 = MDIFF_VECTOR_DIFF[row][col].Y2;
				MDIFF_VECTOR[row][col].Y3 = MDIFF_VECTOR_DIFF[row][col].Y3;
				MDIFF_VECTOR[row][col].Y4 = MDIFF_VECTOR_DIFF[row][col].Y4;
				MDIFF_VECTOR[row][col].ref = MDIFF_VECTOR_DIFF[row][col].ref;
				MDIFF_VECTOR[row][col].ref2 = MDIFF_VECTOR_DIFF[row][col].ref2;
				MDIFF_VECTOR[row][col].ref3 = MDIFF_VECTOR_DIFF[row][col].ref3;
				MDIFF_VECTOR[row][col].ref4 = MDIFF_VECTOR_DIFF[row][col].ref4;
			}
			else {
				MDIFF_VECTOR[row][col].split = MDIFF_VECTOR_DIFF[row][col].split + MDIFF_VECTOR[row][col - 1].split;
				MDIFF_VECTOR[row][col].X = MDIFF_VECTOR_DIFF[row][col].X + MDIFF_VECTOR[row][col - 1].X;
				MDIFF_VECTOR[row][col].X2 = MDIFF_VECTOR_DIFF[row][col].X2 + MDIFF_VECTOR[row][col - 1].X2;
				MDIFF_VECTOR[row][col].X3 = MDIFF_VECTOR_DIFF[row][col].X3 + MDIFF_VECTOR[row][col - 1].X3;
				MDIFF_VECTOR[row][col].X4 = MDIFF_VECTOR_DIFF[row][col].X4 + MDIFF_VECTOR[row][col - 1].X4;
				MDIFF_VECTOR[row][col].Y = MDIFF_VECTOR_DIFF[row][col].Y + MDIFF_VECTOR[row][col - 1].Y;
				MDIFF_VECTOR[row][col].Y2 = MDIFF_VECTOR_DIFF[row][col].Y2 + MDIFF_VECTOR[row][col - 1].Y2;
				MDIFF_VECTOR[row][col].Y3 = MDIFF_VECTOR_DIFF[row][col].Y3 + MDIFF_VECTOR[row][col - 1].Y3;
				MDIFF_VECTOR[row][col].Y4 = MDIFF_VECTOR_DIFF[row][col].Y4 + MDIFF_VECTOR[row][col - 1].Y4;
				MDIFF_VECTOR[row][col].ref = MDIFF_VECTOR_DIFF[row][col].ref + MDIFF_VECTOR[row][col - 1].ref;
				MDIFF_VECTOR[row][col].ref2 = MDIFF_VECTOR_DIFF[row][col].ref2 + MDIFF_VECTOR[row][col - 1].ref2;
				MDIFF_VECTOR[row][col].ref3 = MDIFF_VECTOR_DIFF[row][col].ref3 + MDIFF_VECTOR[row][col - 1].ref3;
				MDIFF_VECTOR[row][col].ref4 = MDIFF_VECTOR_DIFF[row][col].ref4 + MDIFF_VECTOR[row][col - 1].ref4;
			}
		}
	}
}
