...
int CIF_I_TABLE[12] = { 21895,	15549,	10462,	6609,	3838,	2148,	1099,	527,	264,	155,	84,	68};
int CIF_P_TABLE[12] = { 17820,	12157,	7925,	4803,	2789,	1825,	1412,	1250,	221,	158,	134,	123};
//int CIF_I_TABLE[12] = { 22089,	15756,	10715,	6911,	4224,	2634,	1675,	1181,	892,	678,	212,	68 };
//int CIF_P_TABLE[12] = { 18582,	12991,	8739,	5497,	3267,	2102,	1623,	1507,	279,	238,	161,	125 };
//int CIF_I_TABLE[12] = { 22089,	16756,	11715,	6911,	4224,	2634,	1675,	1181,	892,	678,	212,	68 };//Modify QP 0 1 2 * 1.19
...
int QCIF_I_TABLE[12] = { 12308,	9171,	6652,	4588,	2937,	1675,	828,	366,	157,	79,	47,	35};

int QCIF_P_TABLE[12] = { 8903,	6273,	4266,	2776,	1715,	1049,	742,	638,	138,	95,	78,	70};
